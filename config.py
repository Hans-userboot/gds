...
CHANNEL_DB = int(os.environ.get("CHANNEL_DB", "-1001953690069"))
MONGO_URL = os.environ.get("MONGO_URL", "mongodb+srv://adinda:arista@cluster.feeyf4y.mongodb.net/?retryWrites=true&w=majority")
...
try:
    ADMINS = [int(x) for x in (os.environ.get("ADMINS", "6129531464 5178772086").split())]
except ValueError:
